...
class Motor_Driver:
    ...
    def connect(self) -> None:
        ...
        # Speed gains (UNSIGNED32 according to EDS)
        try:
        ...
        # Position gains (UNSIGNED16 in  EDS)
        try:
    ...
    # 8) Target Iq
    # This function is used to set target Iq in Torque control mode
    # The values written by this function will only be effictive, if the motion controller is configured in Torque control mode
    ...
    # 9) send Target position + velocity
    # used in position control mode 
    # position value is the absolute value in revs where you want to command your motor in Revs.
    # velocity is the speed at which you want the motor to travel at the target position 
    ...
    # 10) Velocity
    # used to set velocity in velocity control mode
